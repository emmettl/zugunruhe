...
export function createContinentScene(container, stations, onSelect) {
  ...
  renderer.domElement.setAttribute('aria-label','Continuous luminous layers estimated between thirty-seven radar stations over Western Europe. Drag to orbit and scroll to move closer.');
